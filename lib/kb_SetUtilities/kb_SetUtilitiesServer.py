...
import os
from kb_SetUtilities.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_SetUtilities'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_SetUtilities.kb_SetUtilitiesImpl import kb_SetUtilities  # noqa @IgnorePep8
impl_kb_SetUtilities = kb_SetUtilities(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_SetUtilities'
        ...
        self.rpc_service.add(impl_kb_SetUtilities.KButil_Logical_Slice_Two_FeatureSets,
        ...
        self.rpc_service.add(impl_kb_SetUtilities.KButil_Merge_GenomeSets,
                             ...
                             types=[dict])
        self.method_authentication['kb_SetUtilities.KButil_Merge_GenomeSets'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_SetUtilities.KButil_Build_GenomeSet,
                             name='kb_SetUtilities.KButil_Build_GenomeSet',
                             types=[dict])
        self.method_authentication['kb_SetUtilities.KButil_Build_GenomeSet'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_SetUtilities.KButil_Build_GenomeSet_from_FeatureSet,
                             name='kb_SetUtilities.KButil_Build_GenomeSet_from_FeatureSet',
                             types=[dict])
        self.method_authentication['kb_SetUtilities.KButil_Build_GenomeSet_from_FeatureSet'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_SetUtilities.KButil_Add_Genomes_to_GenomeSet,
